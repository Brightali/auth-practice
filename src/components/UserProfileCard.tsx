...
import { LogOut, Mail, Shield, UserIcon, Users } from "lucide-react";
...
const UserProfileCard = ({ user }: UserProps) => {
    ...
    <Card className="transition-all duration-300 hover:shadow-lg animate-fade-in">
      ...
      <CardFooter className="flex gap-3">
        ...
        <Button
          ...
          variant="outline"
          className="flex-1 group transition-all duration-200 hover:bg-destructive/10  "
        >
